...
# CODUL TĂU VINE MAI JOS:
f_string = f'My name is {name} and {name2} is my name!'
print(f_string)
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
f_string1 = "My name is {name}. But you can call me {name2}.".format(name = "Mihaela", name2 = "Mika")
# CODUL TĂU VINE MAI SUS:

# Concatenează string-ul creat cu string-ul `text`

# CODUL TĂU VINE MAI JOS:
concatenate = f_string1 + text
# CODUL TĂU VINE MAI SUS:
